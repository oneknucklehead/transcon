  ...
  return (
    <>
      <div className="grid gap-4 grid-cols-1 md:grid-cols-12">
        <button
          className="hidden md:flex col-span-1 bg-[#EAEAEA] w-fit h-fit m-auto p-4 rounded-full justify-center items-center"
        ...
        <button
          className="hidden m-auto col-span-1 bg-[#EAEAEA] w-fit h-fit p-4 rounded-full md:flex justify-center items-center"
          onClick={handleNext}
        >
          <span className="hidden lg:block">
            <svg
        ...
        <div className="w-full flex justify-center gap-4">
          <button
            className="bg-[#EAEAEA] p-2 rounded-full block md:hidden"
            onClick={handlePrevious}
          >
            <svg
              width="14"
