            ...
            >
              ...
              <SwiperSlide>
                <div className="flex flex-col gap-3 border-lg bg-white rounded-lg p-5">
                  ...
                  <p>
                    Transcon Electronics stands as the cornerstone of our
                    technological evolution, consistently surpassing
                    expectations with their innovative IT solutions. The company
                    has proven time and again to be an indispensable partner,
                    transforming challenges into opportunities for success.
                  </p>
                  <p className=" font-light">Arpan, Manager at SBI</p>
                </div>
              </SwiperSlide>
            </Swiper>
          </div> */}
