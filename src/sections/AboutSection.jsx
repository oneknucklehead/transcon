...
const AboutSection = () => {
  return (
    <div className="wrapper">
      <Container>
        <div className="break-words w-[80%] mx-auto py-8">
          <div className="grid grid-cols-12 justify-between rounded-lg md:gap-10 bg-[#095DAB] py-5 px-10">
            <div className="flex text-xl pb-6 font-thin flex-col justify-center col-span-12  text-white">
              <h3 className="font-bold text-6xl pb-4">About Us</h3>
              {/* <div className=""> */}
              <p>
